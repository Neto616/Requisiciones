...
router.get("/usuarios", [], async (req, res) => await user_controller.getAll(req, res));
router.get("/usuario/:id", [], async (req, res) => await user_controller.getInfo(req, res));
router.post("/usuario", [], async (req, res) => await user_controller.crear(req, res));
router.put("/usuario/:id", [hasPermission([TIPO_USER.ADMIN])], async (req, res) => await user_controller.actualizar(req, res));
router.delete("/usuario/:id", [], async (req, res) => await user_controller.eliminar(req, res));
